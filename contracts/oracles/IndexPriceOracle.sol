 ...
 */
contract IndexPriceOracle is BaseOracle, ERC165StorageUpgradeable, IIndexPriceOracle {
     ...
     */
    function initialize(address _admin, address[2] calldata _volatilityIndex, bytes32[2] calldata _proofHash, uint256[2] calldata _capRatio,) external initializer {
        _BaseOracle_init([400000000, 400000000], _volatilityIndex, _proofHash, _capRatio, _admin);
