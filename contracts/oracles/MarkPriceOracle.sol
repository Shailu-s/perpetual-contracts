...
contract MarkPriceOracle is BaseOracle {
     ...
     */
    function initialize(uint256[] memory _priceCumulative, address[] memory _asset, address _admin) external initializer {
        _BaseOracle_init(_priceCumulative, _asset, _admin);
    }
}
