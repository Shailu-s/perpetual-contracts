...
contract Positioning is PositioningStorageV1, IPositioning, ReentrancyGuardUpgradeable, PausableUpgradeable, OrderValidator, AccessControlUpgradeable {
    ...
    function _getLiquidatedPositionSizeAndNotional(
        ...
        int256 liquidatedPositionSize = positionSizeToBeLiquidated >= 0 ? (actualLiquidatableSize.toInt256()).neg256() : actualLiquidatableSize.toInt256();        int256 liquidatedPositionNotional = liquidatedPositionSize.mulDiv(indexPrice.toInt256(), _ORACLE_BASE);
