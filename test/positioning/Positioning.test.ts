...
describe("Positioning", function () {
  ...
  describe("setDefaultFeeReceiver", async () => {
    it("should fail to set default fee receiver as zero address", async () => {
        await expect(positioning.connect(owner).setDefaultFeeReceiver(ethers.constants.AddressZero))
  ...
  describe("Match orders:", function () {
    describe("Success:", function () {
      ...
      it("should close the whole position", async () => {
        ...
        const positionSizeAfter = await accountBalance1.getTakerPositionSize(account1.address, orderLeft1.makeAsset.virtualToken)
        const positionSizeAfter1 = await accountBalance1.getTakerPositionSize(account2.address, orderLeft1.makeAsset.virtualToken)
    ...
    describe("failure", function () {
      ...
      it("should fail to match orders as maker is not transaction sender", async () => {
        ...
        await expect(positioning.openPosition(order1, signatureLeft, orderRight, signatureRight, liquidator)).to.be.revertedWith(
